---
title: 01-内核资源控制之cgroups
createTime: 2025/03/21 22:12:18
permalink: /linux/resource/idmo10rb/
---
...
![](attachment/2bb169e48c6903a47977b506abd7fc72.png)
...
![](attachment/f2ce375b5d1ed80e7cda68e114e99e1d.png)
...
上图中的”M×N Linkage” 说明的是`css_set`​通过辅助数据结构可以与 cgroups 节点进行多对多的关联。但是 cgroups 的实现不允许`css_set`​同时关联同一个 cgroups 层级结构下多个节点。 这是因为 cgroups 对同一种资源不允许有多个限制配置。
